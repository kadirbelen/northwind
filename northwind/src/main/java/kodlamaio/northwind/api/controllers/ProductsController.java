...
@RequestMapping("/api/products") //istekte bulunacağımız adres dizaynı 
@CrossOrigin
public class ProductsController {
	...
	@GetMapping("/getall") //veri isteme ::.net de [Httpget]
	//bize kodlama.io/api/products/getall diye bir istek gelirse bu method çalışır
	...
	public DataResult<List<Product>> getProductNameContains(@RequestParam String productName){
		...
		return this.productService.getProductNameContains(productName);
	}
